...
HD_PWD='/home/dmplab/MNGWYw26/umgn/mnghw/mnghw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zedbmg_sys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zedbmg_sys_wrapper.tcl -notrace
