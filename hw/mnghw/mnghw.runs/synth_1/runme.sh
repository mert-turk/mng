...
HD_PWD='/home/dmplab/MNGWYw26/umgn/mnghw/mnghw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zedbmg_sys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zedbmg_sys_wrapper.tcl
